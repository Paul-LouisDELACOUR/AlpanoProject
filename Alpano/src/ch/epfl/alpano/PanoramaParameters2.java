 ...
 */
public final class PanoramaParameters2 {
     ...
     */
    public PanoramaParameters2(GeoPoint observerPosition, int observerElevation, double centerAzimuth, 
  ...
  return Math.abs(Math2.angularDistance(a,  borneInf))  / delta; 
}
    ...
    public double yForAltitude(double a){
        ...
        return Math.abs(Math2.angularDistance(a,  borneSup))  / delta; 
    }
